...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(msg.includes('400') ? 'Email already registered or invalid input.' : msg)
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
          ...
          <p className="text-sm text-gray-500 mb-6">Get started with QA Pipeline</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="passwordConfirm" className="text-xs font-medium text-gray-600">Confirm password</label>
              <input
                id="passwordConfirm"
                type="password"
                autoComplete="new-password"
